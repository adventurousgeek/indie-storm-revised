        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
                    ...
                    <button type="submit" class="btn btn-primary"><svg class="mast-head-button-border"><use xlink:href="#mast-head-button"></use></svg>Learn More</button>
            ...
            <div class="row">
                ...
                <div class="col-xl-4 counter-timer">
...
<section class="what-is">
    <div class="container">
        <div class="row">
            <div class="col-xl-12">
                <ul class="list-inline list-unstyled">
                    <li class="list-inline-item first-inline">Smart Contracts<svg class="smart-contracts-icon"><use xlink:href="#smart-contracts"></use></svg></li>
                    <li class="list-inline-item second-inline"><svg class="pp-network-icon"><use xlink:href="#pp-network"></use></svg>P2P Network</li>
                    <li class="list-inline-item first-inline">indieSTORM Blockchain<svg class="indie-blockchain-icon"><use xlink:href="#indie-blockchain"></use></svg></li>
                    <li class="list-inline-item second-inline"><svg class="consensus-protocol-icon"><use xlink:href="#consensus-protocol"></use></svg>Consensus Protocol</li>
                </ul>
